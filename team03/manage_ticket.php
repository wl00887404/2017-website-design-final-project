		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="container">
					...
					<center>
						<input type="button" value = "查看所有票種" onclick = 'location = "view_ticket.php"'>	
						<input type="button" value = "編輯票種" onclick = 'location = "ticket_edit.php"'>
                        <input type="button" value = "新增票種" onclick = 'location = "add_ticket.php"'>
                		<input type="button" value = "回首頁" onclick = 'location = "manager_index.php"'>
					</center>
                </div>
			</section>
