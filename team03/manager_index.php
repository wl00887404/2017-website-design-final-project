				...
				<div class="container">
					<header class="major">
						...
						<p>請選擇操作</p>
							...
							<center>
							<input type="button" value = "管理訂單" onclick = 'location = "ticket_order.php"'>
								
                   			<input type="button" value = "票種管理" onclick = 'location = "manage_ticket.php"'>	
                    		<input type="button" value = "訊息回復" onclick = 'location = "message_reply.php"'>
							</center>
					</div>
				</section>
