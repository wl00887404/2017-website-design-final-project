...
<body>
    <div style="background-image:url(larm-rmah-273854.jpg)">
            ...
            <nav class="navbar navbar-default" role="navigation" style="background-color:rgb(27, 58, 53); position: relative; margin:0px">
                ...
                <div>
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li>
                            <a class="navfont" href="register.php" style="font-size:20px; padding-top:25px">註冊</a>
                        </li>
                        <li>
                            <a href="#">
        ...
        <div class="container" style="position:relative; margin-top:400px; margin-bottom:20px">
                ...
                ?>
                <form method="post" action="cart2.php?action=add&id=<?php echo $row['sort_no']?>">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="hidden_name" value="<?php echo $row["sort_name"]; ?>">
                        <input type="hidden" name="hidden_price" value="<?php echo $row["sort_price"]; ?>">
                        <li>活動介紹:</li>
                        <?php echo $row['sort_info']?>
                    </ul>
                </div>
                <div class="modal-footer">
                    張數<input type="text" name="quantity" style="width:50px" value="1">
