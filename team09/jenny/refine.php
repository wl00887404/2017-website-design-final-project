    	...
    	<div class="section group">
				<div class="col span_2_of_3">
				  <div class="message-form">
				  	<h2>留言</h2>
            <form  name="comment" action="testup2.php" method="post" >
					    	<div>
						    	<span><label>客戶：<?php echo $name1 ?></label></span>
						    	<span><label>留言內容：	<?php echo $content1 ?></label></span>
						    	<span><label></label><input name="Namead" type="hidden" class="textbox" 
						    		value="<?php echo $numb ?>" readonly = true;  ></span>
						    </div>
						    <div>
						    	<span><label>回覆</label></span>
						    	<span><textarea type="text" name="Messagead" ></textarea></span>
						    </div>
						   <div>
						   		<span><input type="button"  value="送出" class="mybutton" onClick="check()"></span>
						  </div>
					    </form>
				  </div>
  				</div>
