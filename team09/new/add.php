			 ...
			 <div class="clear"></div>
                ...
                <div class="header_bottom">
					<div class="header_bottom_left">				
					 ...
					 <div>
					 <span><label>展覽</label></span>
					 <span><input name="t_name" type="text" class="textbox" ></span>
					 </div>
					 <div>
					 <span><label>票價</label></span>
					 <span><input name="t_price" type="text" class="textbox" ></span>
					 </div>
					 <div>
					 <span><label>張數</label></span>
					 <span><input name="t_rest" type="text" class="textbox" ></span>
					 </div>
					 <div>
					 <span><label>圖片連結</label></span>
					 <span><input name="t_info" type="text" class="textbox"></span>
					 </div>
					 <div>
					 <span><input type="submit" value="送出" class="mybutton"></span>
					 </div>
					 </form>
					 </div>
					 </div>
