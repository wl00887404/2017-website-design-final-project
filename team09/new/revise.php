				  ...
				  <div class="revise-form">
				  	<h2>修改資料</h2>
					    <form method="post" action="change.php">
						    ...
						    <div>
						     	<span><label>新密碼</label></span>
						    	<span><input name="userNewPassword" type="text" class="textbox"></span>
							</div>
							<div>
								<span><label>確認新密碼</label></span>
							    <span><input name="ConUserNewPassword" type="password" class="textbox"></span>
						   </div>
						   <div>
						   		<span><input type="submit" value="修改"  class="mybutton"></span>
						  </div>
					    </form>
				  </div>
  				</div>
