...
$s = $_SESSION['name'];
$sql = "SELECT * FROM myn where name = '$s'";
				...
				<div class="nav_list">
					...
					<div class="account_desc">
						<ul>
							...
							<li><a href="shoppinghistory.php">購物歷史</a></li>
			...
			<div class="col span_2_of_3">
                  ...
                  if ($num > 0) {
                      while ($row = mysqli_fetch_array($rows)) {
                             ...
                             $re = $row["re"];
                  ?>
                  <table  id="show-table" cellpadding = "7" width="650" border = "1">
                  <tr>
                  <th width="65"><div><?php echo $name ?></div></th>
                  <th width="120"><div><?php echo $content ?></div></th>
                  <form action="modify.php" method="post">
                  <th width="45">
                  <div>
                  <input type="submit" name="refine" value="修改" >
                  <input type="hidden" name="numb"  value = "<?php echo $id ?>">
                  <input type="hidden" name="name1"  value = "<?php echo $name ?>">
                  <input type="hidden" name="content1"  value = "<?php echo $content ?>">
                  </div>
                  </th>
                  </form>
                  <th width="53"><div><?php echo $admin ?></div></th>
                  <th width="230"><div><?php echo $re ?></div></th>
                  <form action="testup4.php" method="post">
                  <th width="45">
                  <div>
